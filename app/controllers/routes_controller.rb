class RoutesController < ApplicationController
  ...
  def create
    @route = current_driver.routes.create(route_params)
    
    respond_to do |format|
      if @route.save
        format.html { redirect_to drivers_path, notice: "Route was successfully created." }
        format.json { render drivers_path, status: :created}
      else
